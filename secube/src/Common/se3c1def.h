 ...
 */
enum {
	SE3_KEM_KYBER_PROT_M4 = 0,  ///< Classic McEliece
	SE3_KEM_CRYSTALS_KYBER = 1,  ///< CRYSTALS-KYBER
	SE3_KEM_KYBER_M4 = 2,  ///< CRYSTALS-KYBER
	SE3_KEM_NTRU = 3,  ///< NTRU
	SE3_KEM_NTRU_M4 = 4,  ///< NTRU
	SE3_KEM_SABER = 5,  ///< SABER
	SE3_KEM_SABER_M4 = 6,  ///< SABER
...
enum {
    ...
    SE3_CMD1_CRYPTO_KEM_ENC_REQ_OFF_VAL = 6,
    SE3_CMD1_CRYPTO_KEM_ENC_REQ_OFF_MS_ID = 10,
    SE3_CMD1_CRYPTO_KEM_ENC_REQ_OFF_CS_ID = 14,
    SE3_CMD1_CRYPTO_KEM_ENC_REQ_OFF_SS_ID = 18,
    SE3_CMD1_CRYPTO_KEM_ENC_REQ_OFF_CRSR_DATA = 22,
    SE3_CMD1_CRYPTO_KEM_ENC_REQ_OFF_PK_DATA = 22+64,
...
enum {
    ...
    SE3_CMD1_CRYPTO_KEM_DEC_REQ_OFF_VAL = 6,
    SE3_CMD1_CRYPTO_KEM_DEC_REQ_OFF_MS_ID = 10,
    SE3_CMD1_CRYPTO_KEM_DEC_REQ_OFF_CS_ID = 14,
    SE3_CMD1_CRYPTO_KEM_DEC_REQ_OFF_SS_ID = 18,
    SE3_CMD1_CRYPTO_KEM_DEC_REQ_OFF_CRSR_DATA = 22,
    SE3_CMD1_CRYPTO_KEM_DEC_REQ_OFF_CT_LEN = 30,
    SE3_CMD1_CRYPTO_KEM_DEC_REQ_OFF_CT_DATA = 34,
